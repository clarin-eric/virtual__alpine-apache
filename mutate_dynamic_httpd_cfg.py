    ...
    with provision():
        ...
        sh_cmd('cp -a -f -- {WEBSITE_CFG_TEMPLATE_FILE_PATH:s}'
               ' {WEBSITE_CFG_FILE_PATH:s}'.format(
                   WEBSITE_CFG_TEMPLATE_FILE_PATH=quote(
                       str(WEBSITE_CFG_TEMPLATE_FILE_PATH)),
        ...
        with WEBSITE_CFG_FILE_PATH.open(mode='rt+') as website_cfg_file:
            ...
            website_cfg_file.write(
                WEBSITE_CFG_TEMPLATE.safe_substitute(_SERVERNAME=_SERVERNAME))
